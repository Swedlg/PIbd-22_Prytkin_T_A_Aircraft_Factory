...
using AbstractAircraftFactoryFileImplement.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace AbstractAircraftFactoryFileImplement.Implements
{
	...
	public class OrderStorage : IOrderStorage
	{
		...
		public List<OrderViewModel> GetFilteredList(OrderBindingModel model)
		{
			...
			return source.Orders
                .Where(rec => rec.PlaneId.ToString().Contains(model.PlaneId.ToString()))
                .Select(CreateModel)
                .ToList();
		}
		...
		public OrderViewModel GetElement(OrderBindingModel model)
		{
			...
			.FirstOrDefault(rec => rec.Id == model.Id || rec.PlaneId == model.PlaneId);
		...
		{
			string planeName = "";
			foreach (Plane plane in source.Planes)
			{
