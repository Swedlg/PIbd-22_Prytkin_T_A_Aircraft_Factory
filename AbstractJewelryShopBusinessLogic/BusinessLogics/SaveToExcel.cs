    ...
    static class SaveToExcel
    {
        public static void CreateDoc(ExcelInfo info)
        {
            using (SpreadsheetDocument spreadsheetDocument = SpreadsheetDocument.Create(info.FileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                uint rowIndex = 2;
                foreach (var jewelComponent in info.JewelComponents)
                {
                    InsertCellInWorksheet(new ExcelCellParameters
                    {
                        Worksheet = worksheetPart.Worksheet,
                        ...
                        ColumnName = "A",
                        RowIndex = rowIndex,
                        Text = jewelComponent.JewelName,
                        StyleIndex = 0U
                    });
                    rowIndex++;
                    foreach (var component in jewelComponent.Components)
                    {
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            Worksheet = worksheetPart.Worksheet,
                    ...
                    InsertCellInWorksheet(new ExcelCellParameters
                    {
                        ...
                        ColumnName = "C",
                        RowIndex = rowIndex,
                        Text = jewelComponent.TotalCount.ToString(),
                        StyleIndex = 0U
                    });
                    rowIndex++;
                }
